...
Open the CMD from Anaconda Navigator. And paste the following command to install the recommended python version and create a local environment in Conda.
...
>These added packages are taken from the manifest.json from release 21 branch : agents-r21\Project\Packages
