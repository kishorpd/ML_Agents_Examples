...
>This file is more of a dev log I followed for myself as well. Currently the recommended steps are the minimal steps file. Here is the link to the file : [Minimal Installation steps](./Help/Documentation/1.MinimalStepsInstallation.md).
